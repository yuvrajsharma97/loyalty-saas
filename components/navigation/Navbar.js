...
export default function Navbar() {
  ...
  return (
    <header className="fixed w-full top-0 z-50 bg-white/20 dark:bg-gray-900/20 backdrop-filter backdrop-blur-lg border-b border-gray-200/50 dark:border-gray-700/50">
