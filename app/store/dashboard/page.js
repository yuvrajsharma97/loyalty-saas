  ...
  return (
    <div className="space-y-6">
      ...
      <Banner
        ...
        currentTierProgress.nextLimit} users. Reach ${

        nextTier.charAt(0).toUpperCase() + nextTier.slice(1)} at ${
        currentTierProgress.nextLimit}+ users.`}
        dismissible={false} />
