...
import {
  ...
  adminTierChangeSchema } from
"../../../../lib/validations/admin";
...
async function getStoreDetails(req, res, storeId) {
  try {
    ...
    const visitStatsObj = visitStats.reduce(
      ...
      {
        pending: { count: 0, totalPoints: 0, totalSpend: 0 },
        approved: { count: 0, totalPoints: 0, totalSpend: 0 },
        rejected: { count: 0, totalPoints: 0, totalSpend: 0 }
      }
    );
